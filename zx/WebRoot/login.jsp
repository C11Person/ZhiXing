        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <strong>还没有账号？ <a href="${pageContext.request.contextPath }/company/register.html">立即注册&raquo;</a></strong>
                </div>
            </div>
            <div class="col-sm-5">
                <form method="post" action="${pageContext.request.contextPath }/company/admin/dologin.html">
                    <h4 class="no-margins">登录：</h4>
                    <p class="m-t-md">登录到H+后台主题UI框架</p>
                    <input type="text" name="phone" class="form-control uname" placeholder="用户手机号" />
                    <input type="password" name="password" class="form-control pword m-b" placeholder="密码" />
                    <a href="${pageContext.request.contextPath }/company/updatePassword.html">忘记密码了？</a>
