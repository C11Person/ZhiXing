...
<body class="gray-bg">
					...
					<div class="ibox-content">
						<form class="form-horizontal" id="oi_ad_enter_edite">
							...
							<div class="form-group">
								<input type="hidden" name="company_id"> <label
									class="col-sm-2 control-label">企业名称</label>
								<div class="col-sm-8">
	...
	$(function() {
				...
				var company_id=${requestScope.company};
				...
				success : function(result) {
					...
					$("#type").html("");
					var Str = '<option value="">请选择企业类型</option>'
					for (var i = 0; i < type.length; i++) {
						Str += '<option value="' + type[i].type_id + '">' + type[i].type_name + '</option>';
					};
					$("#type").html(Str);
					
					$("#oi_ad_enter_edite input[name='company_id']").val(Company.company_id);
					...
					$("#oi_ad_enter_edite input[name=audit]").val([Company.audit]).attr("checked",checked);	
				}
			});
			}	
