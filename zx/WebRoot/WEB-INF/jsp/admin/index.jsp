    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_index.html" data-index="0">首页</a>
                            </li>
                        </ul>
                    </li>
                    <!--系统设置：站点设置-->
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_siteSet.html">站点设置</a>
                            </li>
                        </ul>
                    </li>
                    <!--系统设置：站点设置结束-->
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_enter_type.html">类型</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_enter_area.html">地区</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_enter_list.html">列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_enter_check.html">审核</a>
                            </li>
                        </ul>
                    </li>
                    <!--结束:企业管理:类型、地区、列表、审核-->
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_manager.html">管理员</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_character.html">角色</a>
                            </li>
                        </ul>
                    </li>
                    <!--用户和组 结束-->
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/Admin/oi_admin_data_center.html">全国数据</a>
                            </li>
                        </ul>
                    </li>
                    <!--数据中心 结束-->
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="index_v3.jsp" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
