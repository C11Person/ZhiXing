					...
					<div class="ibox-content">
						<form class="form-horizontal" id="oi_ad_enter_edite" onsubmit="return false;">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="用户密码留空不修改"  name="password">
								</div>
							</div>
							<!--水平线-->
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="电话号码" name="phone">
								</div>
							</div>
							<!--水平线-->
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="邮箱号码"  name="email">
								</div>
							</div>
							<!--水平线-->
							<div class="hr-line-dashed"></div>
                        ...
                        <!--水平线 - 结束-->
							...
							<div class="form-group row">
								<button type="submit" class="col-md-offset-5 col-md-2 btn btn-success">确认无误,提交</button>
							</div>		
						</form>
		...
		$(function() {
			$.ajax({
				...
				success : function(result) {
					...
					$("input[name='role']").val(admin.role);
					$("input[name='email']").val(admin.email);
					$("input[name='phone']").val(admin.phone);
					$("input[name='admin_id']").val(admin.admin_id);
					$("#head_div").remove().html("<img src="+admin.head+">");
				}
			});
				}
