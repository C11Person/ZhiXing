...
<html lang="en">
  ...
  <body>
   	<div class="stuff_container">
        <form id="task_release_container2" action="staff/oi_staff_transpond.html" method="post">
            ...
            <div class="weui-cells weui-cells_form">
                ...
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="text"  placeholder="${companyTask.task_title}" disabled>
                    </div>
                </div>
                <!--标题填写结束-->
            </div>
            ...
            <div class="weui-cells">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <input class="weui-input" id="datetime-picker" type="text" name="end_time" value="${currentTime}" readonly="">
                    </div>
                </div>
            </div>
            <!--截止时间结束-->
            ...
            <div class="weui-cells weui-cells_radio">
                ...
                <label class="weui-cell weui-check__label" for="x12">
                    ...
                    <div class="weui-cell__ft">
                        <input type="radio" class="weui-check" name="task_urgent" value="2" id="x12" checked="checked">
                        <span class="weui-icon-checked"></span>
                    </div>
                </label>
                <!--任务级别：紧急 结束-->
            ...
            <div class="weui-cells weui-cells_radio">
                ...
                <label class="weui-cell weui-check__label" for="x14">
                    ...
                    <div class="weui-cell__ft">
                        <input type="radio" class="weui-check" name="task_important" value="2" id="x14"  checked="checked">
                        <span class="weui-icon-checked"></span>
                    </div>
                </label>
                <!--任务级别：紧急 结束-->
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <textarea class="weui-textarea" name="task_content" placeholder="此处留下任务留言" rows="3"></textarea>
            ...
            <div class="form_submit_button">
                <a href="javascript:;" id="oi_quest_change_submit_btn" class="weui-btn weui-btn_primary">确认无误，提交</a>
            </div>
            <!--提交按钮结束-->
        </form>
    </div>
    ...
    <script src="${pageContext.request.contextPath }/statics/js/oi_sf_quest_change.js"></script>
   	<script src="${pageContext.request.contextPath }/statics/js/oi_staff_allpage.js"></script>
        ...
        jQuery(function(){
            /*doSomethings*/
//            发布任务ajax表单提交
            $("#oi_quest_change_submit_btn").click(function(){
                $("#task_release_container2").submit();
            })
        })
    </script>
  </body>
