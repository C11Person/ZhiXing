                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                <button data-target="oi_enter_weList" type="button" class="table_tool_add btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                </button>
                                <button data-target="oi_enter_weList" type="button" class="table_tool_delete btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <table id="oi_enter_weList" data-height="400" data-url="data/table_base.json" data-mobile-responsive="true">
                                <thead>
                                <tr>
                                    ...
                                    <th data-align="center" data-field="weType">类型</th>
                                    <th data-align="center" data-field="weTitle">标题</th>
                                    <th data-align="center" data-field="weNumber">编号</th>
                                    <th data-align="center" data-width="40%" data-field="weID">ID</th>
                                    <th data-align="center" data-width="10%" data-field="sortNumber">排序</th>
                                    <th data-width="10%" data-align="center" data-field="button"></th>
                                </tr>
                                </thead>
                                <tbody>
                                	<c:forEach var="WechatTmpl" items="${listWechatTmpl }">
                                		<tr> 
                                		 <td data-align="center" data-field="oi_type">oi_enter_weList</td>
	                                    <td data-align="center" data-field="oi_type_id">${WechatTmpl.tmpl_id }</td>
	                                    <td data-align="center" data-field="state" data-checkbox="true"></td>
	                                    <td data-align="center" data-field="weType">>${WechatTmpl.type }</td>
	                                    <td data-align="center" data-field="weTitle">${WechatTmpl.title }</td>
	                                    <td data-align="center" data-field="weNumber">${WechatTmpl.serial }</td>
	                                    <td data-align="center" data-width="40%" data-field="weID">${WechatTmpl.template_id }</td>
	                                    <td data-align="center" data-width="10%" data-field="sortNumber">${WechatTmpl.o }</td>
	                                    <td data-width="10%" data-align="center" data-field="button">操作</td>
                                	    </tr>                                                           		
                                	</c:forEach>
                                </tbody>
                            </table>
