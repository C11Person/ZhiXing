    ...
    <div class="col-sm-9">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form action="<%=basePath %>/company/weChatTpl/editWeChat.html" class="form-horizontal" id="oi_ad_enter_edite">
            <!--ID-->
           <input type="hidden" name="tmpl_id" value="${WechatTmpl.tmpl_id }">
            <div class="form-group">
              <label class="col-sm-2 control-label">ID</label>
              <div class="col-sm-8">
                <input type="text" name="template_id" value="${WechatTmpl.template_id }" class="form-control" placeholder="ID">
              </div>
            </div>
            <!--水平线-->
