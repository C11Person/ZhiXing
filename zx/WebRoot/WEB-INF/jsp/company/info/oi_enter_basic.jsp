            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>企业基础设置 <small>请确认所有选项填写无误</small></h5>
                    ...
                    <div class="ibox-content">
                        <form action="<%=basePath %>/company/Basic/updateBasic.html" method="post" class="form-horizontal">
                           	<input type="hidden" value="${companyBasic.b_id }" name="b_id">
                            <!--企业简称-->
                            <div class="form-group">
                                <label class="col-sm-2 control-label">企业简称</label>
                                <div class="col-sm-8">
                                    <input type="text" value="${companyBasic.company_name }" class="form-control" disabled="disabled" placeholder="请填写企业简称">
                                </div>
                            </div>
                            <!--水平线-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="${companyBasic.URL }" name="URL" class="form-control" placeholder="请填写企业网址">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="${companyBasic.slogan }" name="slogan" class="form-control" placeholder="请填写勉励口号">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" value="${companyBasic.period }" name="period" class="form-control" placeholder="请填写经济周期（数字）"/>
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="${companyBasic.standard }" name="standard" class="form-control" placeholder="请填写晋级标准（数字）">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number"  value="${companyBasic.days }" name="days" class="form-control" placeholder="请填写投票天数（数字）">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" value="${companyBasic.panel_point }" name="panel_point"  class="form-control" placeholder="请填写提醒节点（数字）">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" value="${companyBasic.password }"  name="password"  class="form-control" placeholder="请填写默认密码">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
