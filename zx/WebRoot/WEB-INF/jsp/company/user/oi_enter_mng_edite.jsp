            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<%=basePath %>/company/admin/edit.html" class="form-horizontal" id="oi_ad_enter_edite">
                        	<input type="hidden" name="admin_id" value="${companyAdmin.admin_id }"/>
                            <!--用户名称-->
                            <div class="form-group">
                                <label class="col-sm-2 control-label">用户名称</label>
                                <div class="col-sm-8">
                                    <input type="text" name="username" value="${companyAdmin.username }" class="form-control" placeholder="用户名称" disabled>
                                </div>
                            </div>
                            <!--水平线-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text"  name="password" value="${companyAdmin.password }" class="form-control" placeholder="用户密码留空不修改">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="phone" value="${companyAdmin.phone }"  class="form-control" placeholder="电话号码">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="email" value="${companyAdmin.email }" class="form-control" placeholder="邮箱号码">
                                </div>
                            </div>
                            <!--水平线-->
                            <div class="hr-line-dashed"></div>
