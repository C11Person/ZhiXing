                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                <button data-target="oi_admin_mng_table" type="button" class="table_tool_add btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                </button>
                                <button data-target="oi_admin_mng_table" type="button" class="table_tool_delete btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <table id="oi_admin_mng_table" data-height="700" data-url="data/table_base.json" data-mobile-responsive="true">
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                	<c:forEach var="companyAmin" items="${companyAdmins }">
                                		<tr>
                                			 <td data-align="center" data-field="oi_type">oi_enter_mng_table</td>
		                                    <td data-align="center" data-field="oi_type_id">${companyAmin.admin_id }</td>
		                                    <td data-align="center" data-field="state" data-checkbox="true"></td>
		                                    <td data-align="center" data-field="username">${companyAmin.username }</td>
		                                    <td data-align="center" data-field="email">${companyAmin.email }</td>
		                                    <td data-align="center" data-field="phone">${companyAmin.phone }</td>
                                   		</tr>
                                	</c:forEach>
                                </tbody>
                            </table>
