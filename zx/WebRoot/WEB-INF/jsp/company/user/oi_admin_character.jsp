                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                <button data-target="oi_admin_character_table" type="button" class="table_tool_add btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                </button>
                                <button data-target="oi_admin_character_table" type="button" class="table_tool_delete btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <!--数据表格-->
                            <table id="oi_admin_character_table" data-height="700" data-url="data/table_base.json" data-mobile-responsive="true">
                                <thead>
                                <tr>
                                    <th data-align="center" data-field="oi_type"></th>
                                    <th data-align="center" data-field="oi_type_id"></th>
                                    <th data-align="center" data-widht="10%" data-field="state" data-checkbox="true"></th>
                                    <th data-align="center" data-width="90%" data-field="charName">角色用户名</th>
                                    <th data-align="center" data-width="10%" data-field="button">角色用户名</th>
                                </tr>
                                </thead>
                                <tbody>
                                	<c:forEach var="role" items="${listRole }">
                                		<tr>
		                                    <td data-align="center" data-field="oi_type">oi_enter_character_table</td>
		                                    <td data-align="center" data-field="oi_type_id">${role.user_id }</td>
		                                    <td data-align="center" data-widht="10%" data-field="state" data-checkbox="true"></td>
		                                    <td data-align="center" data-width="90%" data-field="charName">${role.title }</td>
		                                    <td data-align="center" data-width="10%" data-field="button">${role.title }</td>
		                                </tr>
                                	</c:forEach>
                                </tbody>
                            </table>
...
<!-- Bootstrap table -->
<script src="${pageContext.request.contextPath }/statics/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
