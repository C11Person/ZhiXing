            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<%=basePath %>/company/dept/edit.html" method="post" accept-charset="UTF-8"  class="form-horizontal" id="oi_ad_enter_edite">
                            ...
                            <div class="form-group row text-center">
                                <input type="submit" value="确认无误,提交" class="col-sm-offset-5 col-sm-2 btn btn-success">
                            </div>
                        </form>
                    </div>
                </div>
