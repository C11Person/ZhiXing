                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                <button data-target="oi_enter_grade" type="button" class="table_tool_add btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                </button>
                                <button data-target="oi_enter_grade" type="button" class="table_tool_delete btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <table id="oi_enter_grade" data-height="400" data-mobile-responsive="true">
                                <thead>
                                <tr>
                                    <th data-field="oi_type"></th>
                                    <th data-field="oi_type_id"></th>
                                    <th data-field="state" data-checkbox="true"></th>
                                    <th data-field="grade_info">职系说明</th>
                                    <th data-width="30%" data-field="grade_name">职系名称</th>
                                    <th data-width="30%" data-field="grade_sort">职系排序</th>
                                    <th data-width="10%" data-align="center" data-field="button">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                	<c:forEach var="companyPost" items="${list }">
                                		<tr>
                                			<td data-field="oi_type">oi_enter_grade</td>
		                                    <td data-field="oi_type_id">${companyPost.post_id }</td>
		                                    <td data-field="state" data-checkbox="true"></td>
		                                    <td data-field="grade_info">${companyPost.post_remark }</td>
		                                    <td data-width="30%" data-field="grade_name">${companyPost.post_name }</td>
		                                    <td data-width="30%" data-field="grade_sort">${companyPost.o }</td>
