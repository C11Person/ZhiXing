                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                <button data-target="oi_enter_staffMng" type="button" class="table_tool_delete btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <table id="oi_enter_staffMng" data-height="400" data-mobile-responsive="true">
                                <thead>
                                <tr>
                                    ...
                                    <th data-align="center" data-field="stuff_number">序号</th>
                                    <th data-align="center" data-field="stuff_name">员工名称</th>
                                    <th data-align="center" data-field="stuff_tel">员工电话</th>
                                    <th data-align="center" data-field="stuff_eta">员工效率</th>
                                    <th data-align="center" data-field="stuff_quality">员工质量</th>
                                    <th data-align="center" data-field="stuff_check">审核</th>
                                    <th data-width="10%" data-align="center" data-field="button">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                	<c:forEach var="staffer" items="${listStaffer }">
                                		<tr>
                                    		<td data-align="center" data-field="oi_type">oi_enter_staffMng</td>
		                                    <td data-align="center" data-field="oi_type_id">${staffer.user_id }</td>
		                                    <td data-align="center" data-field="state" data-checkbox="true"></td>
		                                    <td data-align="center" data-field="stuff_number">${staffer.user_id }</td>
		                                    <td data-align="center" data-field="stuff_name">${staffer.realname }</td>
		                                    <td data-align="center" data-field="stuff_tel">${staffer.account }</td>
		                                    <td data-align="center" data-field="stuff_eta">员工效率</td>
		                                    <td data-align="center" data-field="stuff_quality">员工质量</td>
		                                    <td data-align="center" data-field="stuff_check">${staffer.audit }</td>
